...
ENABLE_SYNTHETIC_PROBLEMS = False
ENABLE_DATASET_REGRESSION_PROBLEMS = True
ENABLE_DATASET_REGRESSION_HD_PROBLEMS = True
...
if (DEBUG_SETTINGS_OVERWRITE):
    ...
    ENABLE_DATASET_REGRESSION_HD_PROBLEMS = True
    ENABLE_TEST_PROBLEMS = False
    #LIST_OF_PROBLEMS.append(problems.BreastCancerHD)
    #LIST_OF_PROBLEMS.append(problems.BreastCancer)
...
if (ENABLE_DATASET_REGRESSION_HD_PROBLEMS):
    LIST_OF_PROBLEMS.extend(list(problems.REGRESSION_HD.values()))
